...
public class MyCameraManager {
    ...
    public MyCameraManager( Activity activity ,KudanOutputWrapper kudanOutput) {

        mKudanOutputWrapper = kudanOutput;
        mActivity = activity;
        myCameraStateCallBack = new MyCameraStateCallBack(mActivity,mBackgroundHandler,kudanOutput);
    }
