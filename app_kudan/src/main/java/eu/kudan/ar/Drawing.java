...
public class Drawing {
     ...
     */
    public static void drawPrimitive(Canvas canvas, Matrix transform, DrawingPrimitive primitive, Point p0, Point p1, Point p2, Point p3, String label) {

        if (primitive == DrawingPrimitive.DRAWING_RECTANGLE) {
            canvas.drawPoint(p0.x,p0.y,new Paint());
            canvas.drawPoint(p1.x,p1.y,new Paint());
            canvas.drawPoint(p2.x,p2.y,new Paint());
            canvas.drawPoint(p3.x,p3.y,new Paint());
            canvas.drawLine(p0.x,p0.y,p2.x,p2.y,new Paint());
