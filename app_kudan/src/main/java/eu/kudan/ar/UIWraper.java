...
public class UIWraper {
    ...
    public void InitView(Activity activity,View.OnClickListener vo) {
        ...
        mSurfaceView = (SurfaceView) activity.findViewById(R.id.surface_view);
...
//        Log.e("LightSnail","kudanAPp  widht = "+mSurfaceView.getWidth() +", height = "+mSurfaceView.getHeight());
//        mCanvasTransform.setRectToRect(mSrcRect, mDstRect, Matrix.ScaleToFit.END);
        ...
        Log.e("LightSnail","UpdateView  mSurfaceView = "+mSurfaceView.getWidth()+"_"+mSurfaceView.getHeight());
        Log.e("LightSnail","UpdateView  mCameraPreviewSize = "+JavaInput.mCameraPreviewSize.getWidth()/2f+"_"+JavaInput.mCameraPreviewSize.getHeight()/2f);
